                ...
                <form onSubmit={onSubmit} className={`rounded-lg border p-4 bg-[color:var(--zenotika-surface)]/60 ${className}`} noValidate>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div className="sm:col-span-2">
                                        <label htmlFor="contact-subject" className="block text-sm font-medium text-[color:var(--foreground)]">Subject <span className="text-[color:var(--zenotika-muted)]">(optional)</span></label>
                                        <input
                                                id="contact-subject"
                                                type="text"
                                                name="subject"
                                        ...
                                        />
                                        {fieldErrors.subject && <p id="contact-subject-error" className="mt-1 text-sm text-red-500">{fieldErrors.subject}</p>}
                                </div>
                                <div className="sm:col-span-2">
